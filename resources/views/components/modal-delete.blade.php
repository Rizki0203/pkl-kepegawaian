      ...
      <div class="modal-content">
        ...
        <form method="POST">
          ...
          <div class="modal-footer">
            <button type="button" class="btn text-danger" data-bs-dismiss="modal">Batalkan</button>
  ...
  <script>
    $(document).ready(function() {
      $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var message = button.data('message') // get value pada atribut data-message pada tag button hapus

                ...
                <div class="form-row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group position-relative mb-4">
                            ...
                            <input name="name" placeholder="Masukkan Nama Karyawan" type="text" class="form-control border-start-0 @error('name') is-invalid @enderror bg-transparent" value="{{ old('name') }}" required>
                            @error('name')
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <div class="input-group position-relative">
                            ...
                            <input name="email" placeholder="Masukkan E-Mail Karyawan" type="text" aria-describedby="helpEmail" class="form-control border-start-0 @error('email') is-invalid @enderror bg-transparent" value="{{ old('email') }}">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>

        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <a href="{{ route('user.kinerja.create') }}" class="btn btn-sm btn-primary">
                        <i class="me-1" data-feather="plus"></i>Tambah Aktifitas
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row no-gutters mb-4 mt-3">
                        ...
                        <div class="col-md-auto">
                            <div class="row no-gutters mb-4">
                                <div class="col-md-auto">
                                    <a href="{{ route('user.kinerja.export', ['tanggal' => @$_GET['tanggal'], 'show' => @$_GET['show']]) }}" target="_blank" class="btn btn-outline-success btn-sm">
